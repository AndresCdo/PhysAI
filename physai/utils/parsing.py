...
# Wolfram heads this module recognises. Retained as module data because
# issue #15 tracks actually enforcing it; today nothing reads it.
...
def is_valid_expression(expression: str) -> Tuple[bool, str]:
    ...
    # NOTE: unknown Wolfram heads are deliberately not rejected here. The
    # check was computed and discarded; rejecting them changes what the
    # engine accepts, so it is tracked separately. See issue #15.
